  ...
  return (
    <div>
      <div className="container mx-auto space-y-12 my-12">
        <Breadcrumb
          ...
          items={[
            ...
            },
            {
              title: (
                <>
                  <span className="text-xl  text-[#555656]">About Us</span>
                </>
              ),
            },
          ]}
        ...
        <div>
            <h3 className="text-lg">What personal information do we collect from the people that visit our website or blog?</h3>
