...
import mobile from "../../../public/images/Group 290693 1.png"
const AppDownload = () => {
  return (
    <section className="bg-[#F2FAED] text-[#333434] my-12 ">
      <div className="container flex flex-col justify-center p-6 mx-auto lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center  text-center rounded-sm lg:max-w-xl xl:max-w-xl lg:text-left">
          ...
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4  lg:mt-0 lg:justify-start">
			<button className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-violet-600 dark:text-gray-50 border">
			...
			<button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-violet-600 dark:text-gray-50 border">
        ...
        <div className="flex items-center justify-center ">
          ...
          <Image className="w-fit" src={mobile}/>
        </div>
      </div>
    </section>
  );
